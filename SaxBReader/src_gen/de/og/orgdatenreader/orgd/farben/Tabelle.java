 ...
 *       &lt;sequence>
 *         &lt;element ref="{}Format"/>
 *         &lt;element ref="{}ORGT_FARBEN" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class Tabelle {
    ...
    @XmlElement(name = "ORGT_FARBEN", required = true)
    protected List<ORGTFARBEN> orgtfarben;
    ...
    /**
     * Gets the value of the orgtfarben property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the orgtfarben property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getORGTFARBEN().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ORGTFARBEN> getORGTFARBEN() {
        if (orgtfarben == null) {
            orgtfarben = new ArrayList<ORGTFARBEN>();
        }
        return this.orgtfarben;
    }
