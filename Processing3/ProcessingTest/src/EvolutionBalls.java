...
public class EvolutionBalls extends PApplet {
	...
	public void draw() {
		...
		fill(255, 255, 255);
		if (balls.size() > maxBallsEver) {
			maxBallsEver = balls.size();
		}
		text("Balls:" + balls.size() + " Max:" + maxBallsEver, 5, 20);
	}
