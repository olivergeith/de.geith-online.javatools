 ...
 *       &lt;sequence>
 *         &lt;element ref="{}DURCHGANGSKNOTEN" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class Tabelle {
    ...
    @XmlElement(name = "DURCHGANGSKNOTEN", required = true)
    protected List<DURCHGANGSKNOTEN> durchgangsknoten;
    ...
    /**
     * Gets the value of the durchgangsknoten property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the durchgangsknoten property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDURCHGANGSKNOTEN().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link DURCHGANGSKNOTEN }
     * 
     * 
     */
    public List<DURCHGANGSKNOTEN> getDURCHGANGSKNOTEN() {
        if (durchgangsknoten == null) {
            durchgangsknoten = new ArrayList<DURCHGANGSKNOTEN>();
        }
        return this.durchgangsknoten;
    }
