...
public class DirectoryInfos {
	...
	private final String[] illegalExtensions = { ".db", ".nfo", ".sfv", ".flv", ".mov", ".mpg", ".avi", ".html", ".htm", ".m3u", ".mp4", ".m4a", ".m4p",
			".ogg", ".wma", ".ini", ".new", ".txt", ".zip", ".rar", ".7z", ".mkv", ".mp2", ".wav", ".lnk", "ds_store", ".ico", ".pls", ".ram", ".asx", ".url",
			".flac", ".log", ".diz", ".dat", ".asf", ".thm"
	...
	public DirectoryInfos(File dir) {
		this.dir = dir;
		subDirs = findSubDirs();
	...
	private File[] findIllegalFiles() {
		final File[] illegalFiles = dir.listFiles(new FilenameFilter() {
			public boolean accept(final File dir, final String name) {
				for (String extension : illegalExtensions) {
